  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        // ── Business & Funding ────────────────────────────────────────────
        { icon: Users, label: "Browse Grants", path: "/grants", adminOnly: true },
        { icon: FolderOpen, label: "Grant Applications", path: "/grant-applications", adminOnly: true },
        { icon: Database, label: "Companies", path: "/companies", adminOnly: true },
        { icon: ScrollText, label: "Business Plans", path: "/business-plans", adminOnly: true },
        { icon: Boxes, label: "Crowdfunding", path: "/crowdfunding", adminOnly: true },
        { icon: CreditCard, label: "Affiliate Dashboard", path: "/affiliate", adminOnly: true },
        { icon: Bell, label: "Referrals", path: "/referrals", adminOnly: true },
        // ── Marketing & SEO ───────────────────────────────────────────────
        { icon: Webhook, label: "SEO Command Centre", path: "/seo", adminOnly: true },
        { icon: ScrollText, label: "Blog Engine", path: "/blog-admin", adminOnly: true },
        { icon: Activity, label: "Marketing Engine", path: "/marketing", adminOnly: true },
        ...
        { icon: Monitor, label: "Health Trends", path: "/fetcher/health-trends", adminOnly: true },
        { icon: Network, label: "Credential Health", path: "/fetcher/credential-health", adminOnly: true },
