#!/usr/bin/env python3
"""Generate all 7 remaining audit pages for Archibald Titan."""
import os

BASE = "/home/ubuntu/archibald-titan-ai/client/src/pages"

def read_copy(name):
    path = f"/home/ubuntu/{name}_copy.txt"
...
# ─── VsCopilotPage ────────────────────────────────────────────────────────────
vs_copilot = r'''import { Link } from "wouter";
...
# ─── VsNoCodePage ─────────────────────────────────────────────────────────────
vs_no_code = r'''import { Link } from "wouter";
...
# ─── VsCloudAiPage ────────────────────────────────────────────────────────────
vs_cloud_ai = r'''import { Link } from "wouter";
...
pages = {
    "VsCopilotPage": vs_copilot,
    "VsNoCodePage": vs_no_code,
    "VsCloudAiPage": vs_cloud_ai,
}
