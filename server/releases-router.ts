...
function sanitizeRelease(release: any) {
  return {
    ...
    fileSizeWindows: release.fileSizeWindows ?? null,
    fileSizeMac: release.fileSizeMac ?? null,
    fileSizeLinux: release.fileSizeLinux ?? null,
    fileSizeAndroid: release.fileSizeAndroid ?? null,
