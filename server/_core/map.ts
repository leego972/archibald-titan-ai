 ...
 * Set GOOGLE_MAPS_API_KEY in Railway environment variables to enable.
...
function getMapsConfig(): MapsConfig {
  ...
  if (!apiKey) {
    throw new Error(
      "Google Maps API key not configured: set GOOGLE_MAPS_API_KEY in Railway environment variables."
    );
  }
