    ...
    parameters: {
      ...
      properties: {
        ...
        content: {
          type: "string",
          description:
            "New file content (required for modify/create, ignored for delete)",
        },
        description: {
          type: "string",
...
const webSearch: Tool = {
  ...
  function: {
    name: "web_search",
    description:
      "Search the web for current information, news, facts, documentation, or any topic. Use this whenever the user asks a question that requires up-to-date information, factual data, research, or anything beyond your training knowledge. Returns search results with titles, snippets, and URLs.",
    parameters: {
      type: "object",
      properties: {
        query: {
...
const webPageRead: Tool = {
  ...
  function: {
    name: "web_page_read",
    description:
      "Read and extract the main text content from a web page URL. Use this after web_search to get full details from a specific search result. Returns the page title and main text content.",
    parameters: {
      type: "object",
      properties: {
        url: {
